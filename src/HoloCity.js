...
export class HoloCity {
  ...
  _styleOsmBuildings(tileset) {
    tileset.style = new Cesium.Cesium3DTileStyle({
      color: {
        conditions: [
          ['${feature["cesium#estimatedHeight"]} > 80', "color('#00e5ff', 0.92)"],
          ['${feature["cesium#estimatedHeight"]} > 30', "color('#00c8e8', 0.88)"],
          ['true', "color('#00a8cc', 0.82)"],
        ],
      },
      show: true,
    });
